...
HRESULT InitTitle(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/title000.png", &g_pTextureTitlelogo);
	...
	// ポリゴンの各頂点座標
	pVtx[4].pos = D3DXVECTOR3(g_posTitlelogo.x - 480, g_posTitlelogo.y + 160, 0.0f);
	pVtx[5].pos = D3DXVECTOR3(g_posTitlelogo.x - 480, g_posTitlelogo.y - 160, 0.0f);
	pVtx[6].pos = D3DXVECTOR3(g_posTitlelogo.x + 480, g_posTitlelogo.y + 160, 0.0f);
	pVtx[7].pos = D3DXVECTOR3(g_posTitlelogo.x + 480, g_posTitlelogo.y - 160, 0.0f);
