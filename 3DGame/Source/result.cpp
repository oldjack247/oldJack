...
#define RESULTLOGO_POSY		(100.0f)	// リザルトロゴの中心Y座標
#define RESULTLOGO_SIZEX	(240.0f)	// リザルトロゴの中心からの幅
#define RESULTLOGO_SIZEY	(50.0f)		// リザルトロゴの中心からの高さ
...
HRESULT InitResult(void)
{
	...
	D3DXCreateTextureFromFile(
		pDevice,
		"data/TEXTURE/result_score_plate0.png",
		&g_pTextureResult[2]);
	...
	// 頂点座標の設定
	pVtx[4].tex = D3DXVECTOR2(0.0, 0.0);
	pVtx[5].tex = D3DXVECTOR2(0.0, 0.0);
	pVtx[6].tex = D3DXVECTOR2(0.0, 0.0);
	pVtx[7].tex = D3DXVECTOR2(0.0, 0.0);
